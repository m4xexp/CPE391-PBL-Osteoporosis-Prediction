...
function Header() {
  return (
    <nav className="flex justify-between h-32 shadow-md items-center font-kanit font-bold px-10 ">
      <a
        href="#_"
        className="relative z-10 flex items-center w-auto text-2xl font-extrabold leading-none text-black select-none uppercase"
      >
        diagnos.
      </a>
